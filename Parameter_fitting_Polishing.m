%% Model Parameters Fitting with experimental data 
...
% Load Stage0_fitted_data.mat from the folder 
...
%% Stored Variables from Stage0_fitted_data.mat file
...
%% The below parameter values are obtained after fitting using Simulated Annealing optimzation algorithm
alpha = [0.30456 0.108642 1.372173 2.013025 1.343399 1.650823];
sigma = [0.001827 0.000103 0.003548 0.002703 0.004522 0.007872];
beta = [0.000242 0.000029 0.000233 0.000038 0.001900 0.001363];
Fiedler = zeros(1,10);
